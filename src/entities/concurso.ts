...
import { gestorconcurso } from './gestorconcurso';
import { questionamento } from './questionamento';
...
export class Concurso {
  ...
  @OneToMany(() => area, area => area.concurso)
  areas: area[];

  @OneToMany(() => arquivo, arquivo => arquivo.concurso)
  arquivos: arquivo[];

  @OneToMany(() => comunicado, comunicado => comunicado.concurso)
  comunicados: comunicado[];

  @OneToMany(
    () => criteriodesempate,
    criteriodesempate => criteriodesempate.concurso,
  )
  criteriodesempates: criteriodesempate[];

  @OneToMany(() => gestorconcurso, gestorconcurso => gestorconcurso.concurso)
  gestorconcursos: gestorconcurso[];

  @OneToMany(() => questionamento, questionamento => questionamento.concurso)
